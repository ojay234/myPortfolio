    ...
    return (
        <div className="flex flex-col gap-6 fixed top-[60%] right-7">
            ...
            w-3 h-3 rounded-full`}
             ...
             <AnchorLink
                className={`${selectedPage === "skills" ? selectedStyles : "bg-gray-600"}
            w-3 h-3 rounded-full`}
                href="#skills"
                onClick={() => setSelectedPage("skills")}>
            </AnchorLink>
             <AnchorLink
                className={`${selectedPage === "projects" ? selectedStyles : "bg-gray-600"}
            w-3 h-3 rounded-full`}
                href="#projects"
                onClick={() => setSelectedPage("projects")}>
            </AnchorLink>
             <AnchorLink
                className={`${selectedPage === "testimonials" ? selectedStyles : "bg-gray-600"}
            w-3 h-3 rounded-full`}
                href="#testimonials"
                onClick={() => setSelectedPage("testimonials")}>
            </AnchorLink>
             <AnchorLink
                className={`${selectedPage === "contacts" ? selectedStyles : "bg-gray-600"}
            w-3 h-3 rounded-full`}
                href="#contacts"
